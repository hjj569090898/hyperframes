      ...
      if (
        ...
        for (t._pt = t._ptCache = 0, T = (C && w(T)) || (T && !C), n = 0; n < E.length; n++) {
          ...
          (t._op && t._op[n] && t.kill(o, t._op[n]),
            R &&
              t._pt &&
              ((Nt = t), I.killTweensOf(o, c, t.globalTime(e)), (_ = !t.parent), (Nt = 0)),
            t._pt && T && (dt[h.id] = 1));
        }
          ...
          if ($(x))
            ...
            for (l in u)
              for (
                ...
                (((E = { ease: (S = C[o]).e, duration: ((S.t - (o ? C[o - 1].t : 0)) / 100) * _ })[
                  l
                ] = S.v),
                  s.to(A, E, D),
                  (D += E.duration));
  ...
  function Jd(t, e) {
    ...
    if (t in ar && n) {
      ...
      if (
        ...
        return;
      (i._gsap.svg && ((this.svgo = i.getAttribute("data-svg-origin")), this.props.push(pr, e, "")),
        (t = dr));
    }
